...
v = th.FloatTensor([[-1, 1, 0], [1, 1, 0], [1, -1, 0], [-1, -1, 0]])[None].cuda()
v = v.expand(b, -1, -1)
vt = th.FloatTensor([[0.2, 0.2], [0.8, 0.2], [0.8, 0.8], [0.2, 0.8]])
vi = th.IntTensor([[0, 1, 2], [2, 3, 0]])
vti = th.IntTensor([[0, 1, 2], [2, 3, 0]])
